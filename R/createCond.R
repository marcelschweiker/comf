...
#' @description \code{createCond} creates a list with standard variables to be used as an input parameter for calculating comfort indices using the function "calcComfInd".
#' @aliases createCond
#' @aliases createcond
