...
#' @references 
#' \url	{http://www.utci.org/}{UTCI} 
#' Original code in Python by Tartarini & Schiavon (2020) \ref{https://doi.org/10.1016/j.softx.2020.100578}
...
calcUTCI <- function(ta, tr, vel, rh) {
  ...
  utciValue = utci_approx(ta, tr, vel, rh)
