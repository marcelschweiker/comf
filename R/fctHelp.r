...
pckgCheck <- function(){
	...
	resSet <- c(-0.13, 5.37, 25, 24.22, 0.18, 0.21, 6.45, 40.48, 0.02, 0.22, 0.2, 23.32, 19.91, 21.92, 23.75, 2.4, 2.3, 0.7, 32.7, 29.2, 36.1, 24.3, 19.4, 28.9, 23.3, 25.1, 0.52, 26.65, 0.63, -0.14, -0.12, 0.02, 0.03, -0.13, 2.27, 28.28)
