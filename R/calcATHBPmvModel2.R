#' PMV based on Adaptive Thermal Heat Balance Framework for Model 2
#' 
#' aliases athb ATHB
#' @description \code{calcATHBpmvModel2} calculates the PMV based on adaptive thermal heat balance framework 
#' @description based on the newest version (2022)
#' 
#' @usage calcATHBpmvModel2(trm, ta, tr, vel, rh, met)
#'
...
#'
#' @return \code{calcATHBpmvModel2} PMV value adapted through the ATHB appoach with model 2
#'
#' 
#' @references 
...
#' @export
#'
#' @examples calcATHBpmvModel2(20, 25, 25, .1, 50, 1.1)

calcATHBpmvModel2 <- function(trm, ta, tr, vel, rh, met){
  ...
  PTSVATHBpmv <- 4.352880 + 0.034156 * LAdpt - 0.180811 * metAdpt - 0.010338 * LAdpt * metAdpt
  PTSVATHBpmv
}
