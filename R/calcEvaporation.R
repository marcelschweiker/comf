...
#' @param ta Air temperatures at local body segments [Degree Celcius]
#' @param rh Relative humidity at local body segments
#' @param ret Total evaporative thermal resistances [m2K/W]
...
#' @return wet : array Local skin wettedness [-].
