#' Calculating Predicted Percentage Dissatisfied due to Draft based on the 2-Node-Model
#'
#' @aliases calcPD pd PD calcpd
#' @description 
#' \code{calcPD} calculates Predicted Percentage Dissatisfied due to Draft based 
...
#' 
#' @return
#' \code{calcPD} returns the Predicted Percentage Dissatisfied due to Draft
#' 
#' @note 
...
calcPD <- function(ta, tr, vel, rh, clo = .5, met = 1, wme = 0, pb = 760, 
