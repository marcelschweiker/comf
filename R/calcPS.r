#' Calculating Predicted Percentage Satisfied with the Level of Air Movement 
#' based on the 2-Node-Model
#'
#' @aliases calcPS ps PS calcps
#' @description 
#' \code{calcPS} calculates Predicted Percentage Satisfied with the Level of Air 
...
#' 
#' @return
#' \code{calcPS} returns the Predicted Percentage Satisfied with the Level of 
#' Air Movement
#' 
#' @note 
...
calcPS <- function(ta, tr, vel, rh, clo = .5, met = 1, wme = 0, pb = 760, 
