...
test_that("calcAD calculates ankle draft correctly", {
  ...
  # Test with IP units
  # Note: We're passing IP units directly to the function, assuming it handles unit conversion
  result_ip <- calcAD(ta = 77, tr = 77, vel = 0.2 * 3.28, rh = 50, met = 1.2, clo = 0.5, vAnkle = 0.4 * 3.28, units = "IP")
